    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-t-xl shadow-lg overflow-hidden">
            <div class="px-6 py-8 md:py-12 text-center bg-gradient-to-br from-primary-50 to-primary-100">
                ...
                <p class="text-lg text-gray-700 max-w-2xl mx-auto mb-6"> {{-- Added mb-6 for spacing --}}
                    Lihat, edit, atau hapus produk yang Anda jual di {{ $store->name }}.
                </p>
                <div class="flex flex-col sm:flex-row justify-center gap-4"> {{-- Added a div for buttons --}}
                    <a href="{{ route('store.index') }}"
                       class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-lg shadow-sm text-primary-700 bg-white hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition duration-150">
                    ...
                    <a href="{{ route('store.products.create') }}"
                       class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-lg shadow-sm text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition duration-150">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10">
                                                {{-- Menggunakan $product->main_image accessor untuk mendapatkan URL gambar --}}
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $product->formatted_current_price }}</div>
                                        @if($product->original_price && $product->original_price > $product->price)
                                            <div class="text-xs text-gray-500 line-through">{{ number_format($product->original_price, 0, ',', '.') }}</div>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
