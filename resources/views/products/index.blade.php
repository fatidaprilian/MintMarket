...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <div>
            ...
            @if(request()->hasAny(['category', 'condition', 'min_price', 'max_price', 'location', 'search']))
                <div class="flex flex-wrap gap-2 mt-2">
                    ...
                    @endif
                    @if(request('category'))
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm bg-primary-600 text-white">
                    ...
                    @endif
                    @if(request('location'))
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm bg-primary-500 text-white">
                            Lokasi: {{ request('location') }}
                            <a href="{{ request()->fullUrlWithQuery(['location' => null]) }}" class="ml-2 text-white/80 hover:text-white">×</a>
                        </span>
                    @endif
                    @if(request('condition'))
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm bg-primary-700 text-white">
        ...
        <div class="flex items-center gap-3">
            <button type="button" id="filterButton" class="inline-flex items-center px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors gap-2">
                ...
                @if(request()->hasAny(['category', 'condition', 'min_price', 'max_price', 'location']))
                    <span class="bg-white text-primary-600 text-xs px-2 py-1 rounded-full font-medium">
            ...
            <div class="flex items-center gap-2">
                ...
                <form action="{{ route('products.index') }}" method="GET" class="inline">
                    ...
                    @endforeach
                    <select name="sort" onchange="this.form.submit()" class="px-3 py-2 border border-gray-300 rounded-md focus:ring-primary-500 focus:border-primary-500 text-sm bg-white">
                ...
                <div class="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow overflow-hidden group">
                    <a href="{{ route('products.show', $product) }}" class="block">
                        ...
                        <div class="p-4">
                            ...
                            <!-- Store Info, Location, and Condition -->
    ...
    @else
        ...
        <div class="text-center py-12">
            <div class="max-w-md mx-auto">
                ...
                <a href="{{ route('products.index') }}" class="inline-flex items-center px-4 py-2 bg-primary-600 text-white rounded-md hover:bg-primary-700">
                    Lihat Semua Produk
                </a>
            </div>
        </div>
            ...
            <form action="{{ route('products.index') }}" method="GET" id="filterForm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="condition" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-primary-500 focus:border-primary-500">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select name="location" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-primary-500 focus:border-primary-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="min_price" value="{{ request('min_price') }}" placeholder="0" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-primary-500 focus:border-primary-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Harga Maximum</label>
                        <input type="number" name="max_price" value="{{ request('max_price') }}" placeholder="1000000" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-primary-500 focus:border-primary-500">
                    </div>
                </div>
                ...
                <div class="flex justify-end space-x-3 pt-6 mt-6 border-t">
                    ...
                    <button type="submit" class="px-4 py-2 bg-primary-600 text-white rounded-md hover:bg-primary-700">Terapkan Filter</button>
                </div>
            </form>
        </div>
    </div>
