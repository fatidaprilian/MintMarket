                        ...
                        <div class="bg-gradient-to-r from-sage-100 to-sage-200 p-6">
                            <div class="flex items-center space-x-4">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h3 class="font-bold text-gray-900 text-lg truncate">{{ $storeName ?: 'Nama Toko' }}</h3>
                                    <p class="text-sm text-gray-600 truncate">{{ $store->city ?? '' }}{{ $store->city && $store->province ? ', ' : '' }}{{ $store->province ?? '' }}</p>
                                </div>
                            </div>
                        </div>
